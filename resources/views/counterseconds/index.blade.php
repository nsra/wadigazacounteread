@extends('counterseconds.layout')

@section('content')
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 text-center mt-4">
            <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                <h2 class="text-center">عدادات منطقة 07</h2>
            </div>
        </div>
    </div>

    <div class="form-group">
        <form action="{{ route('counterseconds.index') }}" method="GET" class=" form-inline align-items-center">
            ...
            <div class="col-lg-4 d-inline-block text-center align-items-center">
                <a class="btn btn-success mt-2" href="{{ route('counterseconds.create') }}">إضافة عداد <i class="fas fa-plus"></i>
                </a>
                <a class="btn btn-warning mt-2" data-toggle="modal" id="smallButton" data-target="#smallModal"
                data-attr="{{ route('refreshsecond') }}" title="تصفير العدادات"> تصفـير الكل <i
                        class="fas fa-undo"></i>
                </a>
                <a class="btn btn-success mt-2" href="{{ route('export_secondcounters') }}"> تصدير كملف <i
        ...
        <table class="table table-bordered">
            ...
            @foreach ($counters as $counter)
                <tr>
                    ...
                    <td>
                        <form action="{{ route('countersecond.update') }}" method="GET" class="update_form">
                            @csrf
                            @method('PUT')
                    ...
                    <td>
                        <a class="btn btn-info btn-sm mt-2" href="{{ route('counterseconds.show', $counter->id) }}"><i
                                class="fas fa-list"></i></a>
                        <a class="btn btn-secondary btn-sm mt-2" href="{{ route('counterseconds.edit', $counter->id) }}"><i
