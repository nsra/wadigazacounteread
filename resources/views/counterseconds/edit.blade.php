...
@section('content')
    <div class="container my-5">
        ...
        <form action="{{ route('counterseconds.update', $counter->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                    <a class="btn btn-danger text-light" data-toggle="modal" id="smallButton" data-target="#smallModal"
                        data-attr="{{ route('countersecond.delete', $counter->id) }}" title="حذف العداد">
                        حذف العداد <i class="fas fa-trash text-light fa-lg"></i>
                    </a>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                    <button type="submit" class="btn btn-primary">ارسال</button>
                    <a class="btn btn-primary" href="{{ route('counterseconds.index') }}"> رجوع</a>
                </div>
            </div>
