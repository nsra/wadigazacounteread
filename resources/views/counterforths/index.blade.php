@extends('counterforths.layout')

@section('content')
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 text-center mt-4">
            <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                <h2 class="text-center">منطقة 00-06</h2>
            </div>
        </div>
    </div>

    <div class="form-group">
        <form action="{{ route('counterforths.index') }}" method="GET" class=" form-inline align-items-center">
            ...
            <div class="col-lg-4 d-inline-block text-center align-items-center">
                <a class="btn btn-success mt-2" href="{{ route('counterforths.create') }}">إضافة عداد <i
                        class="fas fa-plus"></i>
                </a>
                <a class="btn btn-warning mt-2" data-toggle="modal" id="smallButton" data-target="#smallModal"
                    data-attr="{{ route('refreshforth') }}" title="تصفير العدادات"> تصفـير الكل <i class="fas fa-undo"></i>
                </a>
                <a class="btn btn-success mt-2" href="{{ route('export_counters') }}"> تصدير كملف <i
        ...
        <table class="table table-bordered">
            ...
            @foreach ($counters as $counter)
                <tr>
                    ...
                    <td>
                        <form action="{{ route('counterforth.update') }}" method="GET" class="update_form">
                            @csrf
                            @method('PUT')
                    ...
                    <td>
                        <a class="btn btn-info btn-sm mt-2" href="{{ route('counterforths.show', $counter->id) }}"><i
                                class="fas fa-list"></i></a>
                        <a class="btn btn-secondary btn-sm mt-2" href="{{ route('counterforths.edit', $counter->id) }}"><i
