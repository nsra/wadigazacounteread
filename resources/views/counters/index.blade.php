    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 text-center mt-4">
            <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                <h2 class="text-center">منطقة 09</h2>
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        <form action="{{ route('counters.index') }}" method="GET" class=" form-inline align-items-center">
            ...
            <div class="col-lg-4 d-inline-block text-center align-items-center">
                <a class="btn btn-success mt-2" href="{{ route('counters.create') }}">إضافة عداد <i
                        class="fas fa-plus"></i>
                </a>
                <a class="btn btn-warning mt-2" data-toggle="modal" id="smallButton" data-target="#smallModal"
                    data-attr="{{ route('refresh') }}" title="تصفير العدادات"> تصفـير الكل <i class="fas fa-undo"></i>
                </a>
                <a class="btn btn-success mt-2" href="{{ route('export_forthcounters') }}"> تصدير كملف <i
