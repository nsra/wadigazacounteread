...
class CountersecondsExport implements FromCollection, WithStyles, WithHeadings, WithEvents
{
    /**
    ...
    */
    ...
    {
        return Countersecond::select("number","position_number", "subscription_number", "subscriber", "address","counter_number", "previous_read", "current_read", "cups_consumption", "shekels_consumption", "counter_status", "notes")->orderBy('number', 'ASC')->get();
    }
